          ...
          Positioned(
              ...
              child: FadeInUp(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () async {
                    //*Enviar las coordenadas de a donde queremos ir*//
                    ...
                    searchBloc.add(OnDesactivateManuelMarkerEvent());
    ...
    return FadeInLeft(
      ...
      child: CircleAvatar(
        ...
        child: IconButton(
          ...
          onPressed: () {
            BlocProvider.of<SearchBloc>(context).add(OnDesactivateManuelMarkerEvent());
          },
        ),
      ),
    );
